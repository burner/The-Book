...
\begin{tikzpicture}
	...
	\node[ident relationship] (irelation) [below of=ent, node distance=2cm] {Ident Rela};
	\node[attribute] (attr) [below of=ient, node distance=2cm] {Attribute};
	\node[attribute] (pattr) [below of=relation, node distance=2cm] {\discriminator{Partial Key}};
	\node[attribute] (kattr) [below of=irelation, node distance=2cm] {\underline{Primary Key}};
\end{tikzpicture}
